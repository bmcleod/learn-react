...
import sty from './PlasmicMenuButton.module.css'; // plasmic-import: AcS62u6N3jxljG/css

import BarsIcon from './icons/PlasmicIcon__Bars'; // plasmic-import: IISRE_AvQ5ZI8/icon
import TimesIcon from './icons/PlasmicIcon__Times'; // plasmic-import: TczHNYGk4-dPv/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, 'expanded', 'expanded') ? true : true) ? (
          <BarsIcon
            className={classNames(projectcss.all, sty.svg__u5Ijs, {
              [sty.svgexpanded__u5Ijs9JcLk]: hasVariant(
                variants,
                'expanded',
                'expanded'
              ),
        ...
        {(hasVariant(variants, 'expanded', 'expanded') ? true : true) ? (
          <TimesIcon
            className={classNames(projectcss.all, sty.svg__nVdKu, {
              [sty.svgexpanded__nVdKu9JcLk]: hasVariant(
                variants,
                'expanded',
                'expanded'
              ),
