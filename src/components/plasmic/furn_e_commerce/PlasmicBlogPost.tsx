...
import sty from './PlasmicBlogPost.module.css'; // plasmic-import: gtJb5pCoempr4F/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, 'long', 'long') ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__y20L, {
            [sty.freeBoxlong__y20LB6PD7]: hasVariant(variants, 'long', 'long'),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={''}
                className={classNames(sty.img___0Eui)}
      ...
      <p.Stack
        as={'div'}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xvnGb, {
          [sty.freeBoxlong__xvnGbb6PD7]: hasVariant(variants, 'long', 'long'),
        })}
      >
        {p.renderPlasmicSlot({
