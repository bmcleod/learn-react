...
import sty from './PlasmicFeatureItem.module.css'; // plasmic-import: p09lbHgG8Ulsh/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__yK6Wh)}>
        <div className={classNames(projectcss.all, sty.freeBox__rYkkF)} />

        <div className={classNames(projectcss.all, sty.freeBox__hyG6Z)}>
          <p.Stack
            as={'div'}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__btENy)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__bsLu)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <p.Stack
              as={'div'}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___9IGd7)}
            >
              <LinkButton
