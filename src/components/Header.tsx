...
import {
  PlasmicHeader,
  DefaultHeaderProps,
} from './plasmic/furn_e_commerce/PlasmicHeader';
import { HTMLElementRefOf } from '@plasmicapp/react-web';

import { SettingsDrawer, useSettingsDrawer } from './SettingsDrawer';
...
function Header_(props: HeaderProps, ref: HTMLElementRefOf<'div'>) {
  ...
  const [triggerLinkProps, drawerProps] = useSettingsDrawer();
